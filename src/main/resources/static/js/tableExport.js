  ...
  $.fn.tableExport = function (options) {
    ...
    if (defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type
        ...
        if (cell !== null) {
          ...
          if (defaults.type === 'tsv') {
            ...
            if (dataString instanceof Date) {
              ...
              result = replaceAll(result, defaults.csvEnclosure,
      ...
      findTableElements($(el), 'tbody').each(function () {
        rowlength += CollectCsvData(
            findTableElements($(this), defaults.tbodySelector), 'td,th',
            rowlength);
      });
    ...
    } else if (defaults.type === 'excel' && defaults.mso.fileFormat
        === 'xmlss') {
      var docDatas = [];
      var docNames = [];
      ...
      $(el).filter(function () {
        ...
        var ssName = '';
        if (typeof defaults.mso.worksheetName === 'string'
            && defaults.mso.worksheetName.length) {
          ssName = defaults.mso.worksheetName + ' ' + (docNames.length + 1);
        } else if (typeof defaults.mso.worksheetName[docNames.length]
            !== 'undefined') {
        ...
        var rowLength = CollectXmlssData(collectHeadRows($table), 'th,td',
            rowLength);
      ...
      for (var j = 0; j < docDatas.length; j++) {
        xmlssDocFile += '<Worksheet ss:Name="' + docNames[j]
            + '" ss:RightToLeft="' + (defaults.mso.rtl ? '1' : '0') + '">\r' +
            docDatas[j];
        if (defaults.mso.rtl) {
      ...
      var wbout = XLSX.write(wb,
          {type: 'binary', bookType: defaults.mso.fileFormat, bookSST: false});
      ...
      $(el).filter(function () {
        ...
        if (docName === '') {
          docName = defaults.mso.worksheetName || $table.find('caption').text()
              || 'Table';
          docName = $.trim(
      ...
      docFile += "@page { size:" + defaults.mso.pageOrientation
          + "; mso-page-orientation:" + defaults.mso.pageOrientation + "; }";
      docFile += "@page Section1 {size:"
          + pageFormats[defaults.mso.pageFormat][0] + "pt "
          + pageFormats[defaults.mso.pageFormat][1] + "pt";
      ...
      docFile += "@page Section2 {size:"
          + pageFormats[defaults.mso.pageFormat][1] + "pt "
          + pageFormats[defaults.mso.pageFormat][0] + "pt";
      docFile += ";mso-page-orientation:" + defaults.mso.pageOrientation
      ...
      docFile += "</head>";
      docFile += "<body>";
      docFile += "<div class=\"Section" + ((defaults.mso.pageOrientation
          === 'landscape') ? "2" : "1") + "\">";
      docFile += docData;
      docFile += "</div>";
      docFile += "</body>";
          ...
          $(el).filter(function () {
            ...
            if (typeof atOptions.createdHeaderCell !== 'function') {
              ...
              atOptions.createdHeaderCell = function (cell, data) {
                ...
                if (typeof teOptions.columns [data.column.dataKey]
                  ...
                  cell.styles.halign = (atOptions.headerStyles.halign
                      === 'inherit') ? 'center' : atOptions.headerStyles.halign;
            ...
            if (typeof atOptions.createdCell !== 'function') {
              ...
              atOptions.createdCell = function (cell, data) {
                var tecell = teOptions.teCells [data.row.index + ":"
                + data.column.dataKey];

                cell.styles.halign = (atOptions.styles.halign === 'inherit')
                    ? 'center' : atOptions.styles.halign;
                cell.styles.valign = atOptions.styles.valign;

                if (typeof tecell !== 'undefined' && typeof tecell.style
                    !== 'undefined' && tecell.style.hidden !== true) {
              ...
              ForEachVisibleCell(this, 'td,th', rowIndex,
                  ...
                  function (cell, row, col) {
                    ...
                    if (typeof cell !== 'undefined' && cell !== null) {
                      ...
                      obj.elements = obj.isCanvas ? $(cell) : $(
                          cell).children();
    ...
    function findTableElements($parent, selector) {
      ...
      return $parent.find(selector).filter(function () {
        return parentLevel === $(this).closest(parentSelector).parents(
        ...
        if (defaults.ignoreColumn.length > 0) {
          if ($.inArray(colIndex, defaults.ignoreColumn) !== -1 ||
              ...
              (colNames.length > colIndex && typeof colNames[colIndex]
                  !== 'undefined' &&
                  $.inArray(colNames[colIndex], defaults.ignoreColumn)
                  !== -1)) {
            result = true;
          }
        }
    ...
    function escapeRegExp(string) {
      return string == null ? "" : string.toString().replace(
          /([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1");
    }

    function replaceAll(string, find, replace) {
      return string == null ? "" : string.toString().replace(
          new RegExp(escapeRegExp(find), 'g'), replace);
    }
        ...
        if (defaults.htmlContent === true) {
          ...
          if (cellFormat !== '') {
            ...
            $.each(obj.text().split("\u2028"), function (i, v) {
              ...
              text += (defaults.preserve.trailingWS !== true) ? trimRight(v)
                  : v;
            });
            ...
            if (defaults.type === 'json' ||
                (defaults.type === 'excel' && defaults.mso.fileFormat
                    === 'xmlss') ||
        ...
        if (DownloadLink) {
          ...
          if (typeof data === 'object') {
            ...
            blobUrl = window.URL.createObjectURL(
                new Blob(binaryData, {type: header}));
