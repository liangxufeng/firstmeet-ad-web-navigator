...
var Metronic = function () {
  ...
  var handlePortletTools = function () {
    ...
    $('body').on('click', '.portlet > .portlet-title > .tools > a.remove',
        function (e) {
          ...
          portlet.find(
              '.portlet-title > .tools > .collapse, .portlet > .portlet-title > .tools > .expand').tooltip(
              'destroy');
        ...
        function (e) {
          ...
          if (portlet.hasClass('portlet-fullscreen')) {
            ...
            var height = Metronic.getViewPort().height -
                ...
                parseInt(
                    portlet.children('.portlet-body').css('padding-bottom'));
    ...
    if ($('body').hasClass('page-md')) {
      ...
      $('body').on('click', 'a.btn, button.btn, input.btn, label.btn',
          function (e) {
            ...
            circle.css({top: y + 'px', left: x + 'px'}).addClass(
                "md-click-animate");
  ...
  var handleiCheck = function () {
    ...
    $('.icheck').each(function () {
      var checkboxClass = $(this).attr('data-checkbox') ? $(this).attr(
          'data-checkbox') : 'icheckbox_minimal-grey';
      var radioClass = $(this).attr('data-radio') ? $(this).attr('data-radio')
          : 'iradio_minimal-grey';

      if (checkboxClass.indexOf('_line') > -1 || radioClass.indexOf('_line')
          > -1) {
        $(this).iCheck({
          checkboxClass: checkboxClass,
          radioClass: radioClass,
          insert: '<div class="icheck_line-icon"></div>' + $(this).attr(
              "data-label")
        });
      } else {
        $(this).iCheck({
  ...
  var handleModals = function () {
    ...
    $('body').on('hide.bs.modal', function () {
      if ($('.modal:visible').size() > 1 && $('html').hasClass('modal-open')
          === false) {
  ...
  return {
    ...
    startPageLoading: function (options) {
      if (options && options.animate) {
        ...
        $('.page-loading').remove();
        $('body').append(
            '<div class="page-loading"><img src="' + this.getGlobalImgPath()
    ...
    alert: function (options) {
      ...
      var html = '<div id="' + id + '" class="Metronic-alerts alert alert-'
          + options.type + ' fade in">' + (options.close
              ...
              : '') + (options.icon !== "" ? '<i class="fa-lg fa fa-'
              + options.icon + '"></i>  ' : '') + options.message + '</div>';
